...
namespace DomainFramework.Core
{
        ...
        where TEntity : IEntity
    {
        ...
        {
            var linkedEntityRepository = (IEntityCommandRepository)repositoryContext.CreateCommandRepository(typeof(TEntity));
            ...
            var rootEntityRepository = (IEntityCommandRepository)repositoryContext.CreateCommandRepository(typeof(TEntity));
