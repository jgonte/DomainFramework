...
CREATE PROCEDURE [EmployeeBoundedContext].[pEmployee_UnlinkDependants]
    @employeeId INT
AS
BEGIN
    UPDATE [EmployeeWithDependants].[EmployeeBoundedContext].[Person]
    ...
    WHERE [ProviderEmployeeId] = @employeeId;
...
CREATE PROCEDURE [EmployeeBoundedContext].[pEmployee_GetAllDependants]
    @employeeId INT
AS
BEGIN
    SELECT
