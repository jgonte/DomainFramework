...
namespace ExecutiveEmployeePersonCustomer.ExecutiveBoundedContext
{
    public class CustomerCommandRepository : EntityCommandRepository<Customer>
    {
        ...
        protected override Command CreateUpdateCommand(Customer entity, IAuthenticatedUser user)
        {
            return Command
                .NonQuery()
                .Connection(ExecutiveEmployeePersonCustomerConnectionClass.GetConnectionName())
        ...
        protected override Command CreateDeleteCommand(Customer entity, IAuthenticatedUser user)
        {
            return Command
                .NonQuery()
                .Connection(ExecutiveEmployeePersonCustomerConnectionClass.GetConnectionName())
