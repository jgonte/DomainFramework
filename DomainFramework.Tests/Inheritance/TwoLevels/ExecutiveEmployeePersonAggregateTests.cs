...
",
        ...
        public async Task Executive_Employee_Aggregate_Inherits_From_Person_Save_Async_Tests()
        {
            ...
            var executiveEntity = new ExecutiveEntity
            {
                Bonus = 900000
            };
            ...
            var commandAggregate = new ExecutiveEmployeePersonCommandAggregate(context, executiveEntity);

            commandAggregate.SetEmployee(employeeEntity);

            commandAggregate.SetPerson(personEntity);
            ...
            Assert.AreEqual(executiveId, employeeEntity.Id);
        ...
        public void Executive_Employee_Aggregate_Inherits_From_Person_Tests()
        {
            ...
            var executiveId = employeeEntity.Id;
