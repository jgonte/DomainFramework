...
namespace DomainFramework.Tests
{
    ...
    {
        public override IEnumerable<BookEntity> Get(CollectionQueryParameters parameters, IAuthenticatedUser user)
        {
        ...
        public override Task<IEnumerable<BookEntity>> GetAsync(CollectionQueryParameters parameters, IAuthenticatedUser user)
        {
