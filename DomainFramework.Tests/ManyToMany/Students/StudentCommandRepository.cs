...
{
    class StudentCommandRepository : CommandRepository<StudentEntity, Guid?>
    {
        protected override Command CreateInsertCommand(StudentEntity entity)
        {
        ...
        protected override Command CreateUpdateCommand(StudentEntity entity)
        {
            throw new NotImplementedException();
        }

        protected override Command CreateDeleteCommand(StudentEntity entity)
        {
            throw new NotImplementedException();
        }
