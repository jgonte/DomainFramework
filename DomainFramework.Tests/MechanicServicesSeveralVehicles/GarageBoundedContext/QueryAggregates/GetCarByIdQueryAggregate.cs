...
namespace MechanicServicesSeveralVehicles.GarageBoundedContext
{
    public class GetCarByIdQueryAggregate : GetByIdQueryAggregate<Car, int, CarOutputDto>
    {
        ...
        public GetCarByIdQueryAggregate(HashSet<(string, IEntity)> processedEntities = null) : base(new DomainFramework.DataAccess.RepositoryContext(MechanicServicesSeveralVehiclesConnectionClass.GetConnectionName()), processedEntities)
        {
