...
namespace MechanicServicesSeveralVehicles.GarageBoundedContext
{
    public class GetTruckByIdQueryAggregate : GetByIdQueryAggregate<Truck, int?, TruckOutputDto>
    {
        ...
        public GetTruckByIdQueryAggregate(HashSet<(string, IEntity)> processedEntities = null) : base(new DomainFramework.DataAccess.RepositoryContext(MechanicServicesSeveralVehiclesConnectionClass.GetConnectionName()), processedEntities)
        {
