...
namespace MechanicServicesSeveralVehicles.GarageBoundedContext
{
    public class GetVehicleByIdQueryAggregate : GetByIdQueryAggregate<Vehicle, int?, VehicleOutputDto>
    {
        ...
        public GetVehicleByIdQueryAggregate(HashSet<(string, IEntity)> processedEntities = null) : base(new DomainFramework.DataAccess.RepositoryContext(MechanicServicesSeveralVehiclesConnectionClass.GetConnectionName()), processedEntities)
        {
