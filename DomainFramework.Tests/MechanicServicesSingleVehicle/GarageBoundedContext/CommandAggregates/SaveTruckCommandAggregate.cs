...
namespace MechanicServicesSingleVehicle.GarageBoundedContext
{
    public class SaveTruckCommandAggregate : CommandAggregate<Truck>
    {
        ...
        public SaveTruckCommandAggregate(TruckInputDto truck, EntityDependency[] dependencies = null) : base(new DomainFramework.DataAccess.RepositoryContext(MechanicServicesSingleVehicleConnectionClass.GetConnectionName()))
        {
