...
namespace DomainFramework.Tests.SchoolRoleOrganizationAddress
{
    ...
    {
        protected override Command CreateInsertCommand(Address entity, IAuthenticatedUser user)
        {
            var command = Query<Address>
                .Single()
                .Connection(TestConnectionClass.GetConnectionName())
                .StoredProcedure("[pAddress_Insert]")
                .Parameters(
        ...
        protected override Command CreateUpdateCommand(Address entity, IAuthenticatedUser user)
        {
            return Command
                .NonQuery()
                .Connection(TestConnectionClass.GetConnectionName())
                .StoredProcedure("[pAddress_Update]")
                .Parameters(
        ...
        protected override Command CreateDeleteCommand(Address entity, IAuthenticatedUser user)
        {
            return Command
                .NonQuery()
                .Connection(TestConnectionClass.GetConnectionName())
                .StoredProcedure("[pAddress_Delete]")
                .Parameters(
                    p => p.Name("addressId").Value(entity.Id)
                );
        }
        ...
        protected override Command CreateDeleteCollectionCommand(Address entity, IAuthenticatedUser user, string selector)
        {
            switch (selector)
            {
                case "Role": return Command
                    .NonQuery()
                    .Connection(TestConnectionClass.GetConnectionName())
                    .StoredProcedure("[pAddress_DeleteRole]")
                    .Parameters(
                        p => p.Name("addressId").Value(entity.Id)
                    );
                ...
                case "Organization": return Command
                    .NonQuery()
                    .Connection(TestConnectionClass.GetConnectionName())
                    .StoredProcedure("[pAddress_DeleteOrganization]")
                    .Parameters(
                        p => p.Name("addressId").Value(entity.Id)
                    );
                ...
                case "Organizations": return Command
                    .NonQuery()
                    .Connection(TestConnectionClass.GetConnectionName())
                    .StoredProcedure("[pAddress_DeleteOrganizations]")
                    .Parameters(
                        p => p.Name("addressId").Value(entity.Id)
                    );
