...
namespace DomainFramework.Tests.SchoolRoleOrganizationAddress
{
    ...
    {
        protected override Command CreateInsertCommand(Organization entity, IAuthenticatedUser user)
        {
            if (user != null)
            {
            ...
            var command = Query<Organization>
                ...
                .StoredProcedure("[pOrganization_Insert]")
                .Parameters(
        ...
        protected override Command CreateUpdateCommand(Organization entity, IAuthenticatedUser user)
        {
            ...
            return Command
                .NonQuery()
                .Connection(TestConnectionClass.GetConnectionName())
                .StoredProcedure("[pOrganization_Update]")
                .Parameters(
        ...
        protected override Command CreateDeleteCommand(Organization entity, IAuthenticatedUser user)
        {
            return Command
                .NonQuery()
                .Connection(TestConnectionClass.GetConnectionName())
                .StoredProcedure("[pOrganization_Delete]")
                .Parameters(
                    p => p.Name("organizationId").Value(entity.Id)
                );
        }
