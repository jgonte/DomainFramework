...
{
    class PersonQueryRepository4 : Core.QueryEntityRepository<PersonEntity3, int?>
    {
        ...
        public override async Task<IEnumerable<IEntity>> GetAsync(QueryParameters parameters, IAuthenticatedUser user)
        {
